...
public class Test {
    public static void main(String[] args) {
        ...
        quanLy.themSach(new SachGiaoTrinh("SGT07", "Toan Cao Cap A1", "Nguyen Van A", 2020, 150, 85000.0,"A3", "Toan Hoc", "Dai Hoc"));
        quanLy.themSach(new SachTieuThuyet("STT05", "Hoang Tu Be", "Antoine de Saint-Exupéry", 1943, 80, 50000.0,"B2","Huyen Ao", false));
        quanLy.themSach(new SachTieuThuyet("STT06", "Harry Potter Tap 1", "J.K. Rowling", 1997, 200, 120000.0,"B1", "Fantasy", true));
